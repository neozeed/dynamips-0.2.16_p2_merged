...
#endif //end stub term_reset/term_init
...
#ifdef __MINGW32__
//no serial port functions
int vtty_parse_serial_option(vtty_serial_option_t *option, char *optarg){return 0;}
static int vtty_serial_setup(vtty_t *vtty, const vtty_serial_option_t *option){return 0;}
#else
/* 
...
#ifdef __MINGW32__
if(vtty->type==VTTY_TYPE_TERM)
	{

	if(kbhit())
		return(_getch());		//doesn't really work needs to return raw keyboard stuff...
	}
#endif
...
/* On MinGW I get a -1 return but perror says
