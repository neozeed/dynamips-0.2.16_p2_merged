...
#include "../contrib/libelf-0.8.13/lib/libelf.h"
...
#define DEBUG_MTS_ACC_U        0   /* undefined memory */
#define DEBUG_MTS_ACC_T        0   /* tlb exception */
#define DEBUG_MTS_ACC_AE       0   /* address error exception */
...
#define DEBUG_UNKNOWN          0   /* used by all the IO stuff dev/io_fpga */
